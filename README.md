...
"to tte" is the romanization of the Japanese word "取って", which is exactly "fetch" in English, and "embus" is also very similar to "tote", so I used it as the name of the project.
